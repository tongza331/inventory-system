...
urlpatterns = [
    ...
    path('password_reset_complete/', auth_views.PasswordResetCompleteView.as_view(template_name='user/password_reset_complele.html'), name='password_reset_complete'),
